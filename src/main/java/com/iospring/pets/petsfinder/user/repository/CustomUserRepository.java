...
//      List<UserDTO> createUserDTOFromObjectForDetectBoard(List<Object[]> list);
    List<DetectUserAlarmDto> findUsersIn3KM2(double latitude, double longitude);
    List<FindUserAlarmDto> findUsersIn3KmWhenUploadFinderBoard2(double latitude, double longitude, String breed, String color, String missingTime);
